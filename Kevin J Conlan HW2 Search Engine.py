''' Kevin J Conlan
    ...
    HW 2: "Search Engine" for The Little Prince
    9/18/2015
    This program will ask the user to enter multiple keywords and boolean        operators in a "search engine" of "The Little Prince"    
'''
...
searches = []
query=input("query:")
if not query.find("or")==True:
	print("your search includes 'or' ")
	searches=query.split(' or ')
	for both in searches:
		print(searches)
		for i,quote in enumerate(data_list):
			found_at = quote.find(both)
			if( found_at >= 0):
